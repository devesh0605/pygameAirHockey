...
class Puck:
    ...
    def collision_paddle(self, paddle):
        ...
        vec_a1 = self.angle
        vec_a2 = self.speed * (self.mass - paddle.mass) / total_mass
        vec_b1 = temp_angle
        vec_b2 = 2 * paddle.speed * paddle.mass / total_mass

        (self.angle, self.speed) = self.add_vectors(vec_a1, vec_a2, vec_b1, vec_b2)
        ...
        vec_a1 = paddle.angle
        vec_a2 = paddle.speed * (paddle.mass - self.mass) / total_mass
        vec_b1 = temp_angle + math.pi
        vec_b2 = 2 * self.speed * self.mass / total_mass

        temp_speed = paddle.speed
        (paddle.angle, paddle.speed) = self.add_vectors(vec_a1, vec_a2, vec_b1, vec_b2)
